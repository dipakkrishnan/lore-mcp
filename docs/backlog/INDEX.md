...
| [BP-001](./blueprint/BP-001-clarify-privacy-in-persona-interview-topic-prompts.md) | Clarify that persona-interview topic/domain answers stay private | P2 | S | blueprint | in-review | — | — | — | — |
| [DOC-002](./docs/DOC-002-document-lore-as-an-interactive-masterclass.md) | Document Lore as an interactive masterclass and coaching surface | P2 | XS | docs | in-review | XC-002, MCP-001 | — | — | — |
...
| [MON-009](./monetization/MON-009-decide-publication-pricing-granularity.md) | Decide pricing granularity beyond one global publication price | P2 | M | monetization | in-review | MON-002, MON-003, MCP-001, MCP-003 | — | — | — |
...
| [XC-007](./cross-cutting/XC-007-pr-templates-for-backlog-skills.md) | Add reusable PR templates the backlog skills can reference | P2 | M | cross-cutting | in-review | — | — | — | — |
...
| [MON-002](./monetization/MON-002-complete-the-base-sepolia-canary-payment.md) | Complete the Base Sepolia canary payment end to end | P1 | S | monetization | completed | MON-003 | — | "Funded Base Sepolia buyer wallet (faucet test USDC)", "Cloudflare account for deployment" | [#25](https://github.com/dipakkrishnan/lore-mcp/issues/25) |
