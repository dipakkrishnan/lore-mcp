...
| [MON-003](./monetization/MON-003-lore-enable-payments-skill-for-payout-and-price-config.md) | Add a lore-enable-payments skill for payout and price configuration | P1 | M | monetization | in-review | MON-002, ONB-002, DEP-001 | MON-002 | Coinbase Wallet (owner-controlled, Base network); Coinbase CDP account with x402 API keys; Second testnet wallet + Base Sepolia USDC faucet funds for the buyer harness | — |
