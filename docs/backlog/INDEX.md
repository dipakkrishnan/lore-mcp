...
| [MCP-002](./mcp-server/MCP-002-one-source-of-truth-for-the-mcp-tool-surface.md) | Keep one source of truth for the MCP tool surface | P2 | M | mcp-server | in-review | MON-003, MCP-001, XC-004, XC-008 | — | — | — |
...
| [MON-006](./monetization/MON-006-split-deploy-into-its-own-skill.md) | Move deploy mechanics from the skill into the CLI when edge serving lands | P2 | M | monetization | in-review | MON-002, MON-005, XC-005 | MON-003 | — | — |
| [MON-008](./monetization/MON-008-stand-up-a-standing-base-sepolia-qa-deployment.md) | Stand up a standing Base Sepolia QA deployment of the Worker | P2 | M | monetization | in-review | MON-002, MON-003, MON-005, MON-006, MON-007, XC-008 | MON-002 | "Cloudflare account with Workers and D1", "Base Sepolia wallet funded from the CDP faucet", "GitHub repository secrets for the deploy token" | — |
...
| [XC-007](./cross-cutting/XC-007-gate-pull-requests-on-a-lint-and-format-check.md) | Gate pull requests on a lint and format check | P2 | S | cross-cutting | in-review | XC-003, XC-004 | XC-004 | — | — |
| [XC-008](./cross-cutting/XC-008-run-the-live-testnet-suite-against-the-qa-deployment.md) | Run a live testnet suite against the QA deployment | P2 | M | cross-cutting | in-review | XC-004, XC-007, MON-002, MON-007, MON-008, MCP-002 | XC-004, MON-008 | "Base Sepolia buyer wallet with a monitored faucet balance", "GitHub repository secrets for the buyer key" | — |
| [XC-009](./cross-cutting/XC-009-type-check-lore-with-mypy.md) | Type-check lore/ with mypy so its annotations mean something | P2 | S | cross-cutting | in-review | XC-003, XC-004, XC-007 | XC-004 | — | — |
...
| [XC-004](./cross-cutting/XC-004-run-tests-and-checks-in-ci-on-every-pull-request.md) | Run tests and checks in CI on every pull request | P0 | S | cross-cutting | ready | XC-003, XC-007, XC-008, MON-007, MCP-002 | — | — | — |
...
| [MON-002](./monetization/MON-002-complete-the-base-sepolia-canary-payment.md) | Complete the Base Sepolia canary payment end to end | P1 | S | monetization | ready | MON-003, MON-007, MON-008 | — | "Funded Base Sepolia buyer wallet (faucet test USDC)", "Cloudflare account for deployment" | [#25](https://github.com/dipakkrishnan/lore-mcp/issues/25) |
| [MON-007](./monetization/MON-007-test-the-paid-path-against-a-mocked-facilitator.md) | Test the Worker's paid path against a mocked facilitator | P1 | M | monetization | ready | MON-002, MON-003, MON-008, XC-004 | — | — | — |
| [XC-005](./cross-cutting/XC-005-dry-run-owner-skills-as-conversations.md) | Dry-run every owner skill as a conversation, not just a document | P1 | M | cross-cutting | ready | XC-004, MON-006 | — | — | — |
