...
| [MCP-001](./mcp-server/MCP-001-browsable-publication-tree-for-discovery.md) | Give discover an owner-approved manifest of the node's offerings | P2 | L | mcp-server | in-review | STO-001, XC-002 | — | — | — |
