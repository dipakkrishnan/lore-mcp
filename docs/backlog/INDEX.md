...
| [MON-006](./monetization/MON-006-split-deploy-into-its-own-skill.md) | Split node deployment out of lore-enable-payments into its own skill | P2 | S | monetization | in-review | MON-002, MON-005, XC-005 | MON-003 | — | — |
