...
| [DEP-002](./deployment/DEP-002-aws-provider-s3-bundle-and-lambda-mcp-endpoint.md) | Add the AWS provider — S3 bundle and Lambda MCP endpoint | P1 | L | deployment | in-review | DEP-001, DEP-003, MON-007, XC-007 | DEP-001 | "AWS account (owner-controlled)" | — |
| [MON-007](./monetization/MON-007-land-the-in-process-x402-payment-gate.md) | Land the in-process x402 payment gate with the Coinbase facilitator | P1 | M | monetization | in-review | MON-001, MON-008, STO-001, XC-002, XC-007 | — | Coinbase CDP account with x402 API keys; x402 and cdp Python packages (payment-only runtime deps; pydantic arrives earlier via PR #19) | — |
| [MON-008](./monetization/MON-008-lore-enable-payments-skill-for-payout-and-price-config.md) | Add a lore-enable-payments skill for payout and price configuration | P1 | M | monetization | in-review | MON-007, ONB-002, DEP-001 | MON-007 | Coinbase Wallet (owner-controlled, Base network); Coinbase CDP account with x402 API keys; Second testnet wallet + Base Sepolia USDC faucet funds for the buyer harness | — |
| [ONB-002](./onboarding/ONB-002-hand-off-to-a-branch-when-onboarding-completes.md) | Hand off to a named branch when onboarding completes | P1 | S | onboarding | in-review | ONB-003, DEP-001, MON-008 | — | — | — |
...
| [DEP-003](./deployment/DEP-003-cloudflare-provider-r2-bundle-and-worker-mcp-endpoint.md) | Add the Cloudflare provider — R2 bundle and Worker MCP endpoint | P2 | L | deployment | in-review | DEP-001, DEP-002, MON-001, XC-007 | DEP-001 | "Cloudflare account (owner-controlled)" | — |
...
| [XC-007](./cross-cutting/XC-007-resolve-where-the-payment-gate-runs-for-a-deployed-node.md) | Resolve where the payment gate runs for a deployed node | P1 | S | cross-cutting | obsolete | DEP-001, DEP-002, DEP-003, MON-007, MON-008 | — | — | — |
