...
const skillPath = join(repoRoot, "plugins/lore/skills", skillName, "SKILL.md");
...
const systemPrompt =
  ...
  "panel; you have exactly three tools (lore_cli, read_context_file, ask_user) and no " +
  "shell. Follow the skill below as your instructions. Where the skill mentions " +
...
const agent = new Agent({
  ...
  initialState: {
    systemPrompt,
    model,
    tools: createLoreTools(loreHome)
  }
});
