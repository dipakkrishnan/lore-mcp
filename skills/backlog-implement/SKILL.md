...
description: Take a ready backlog item under docs/backlog/ to completed. Use when the user says "work the backlog", "implement the next backlog item", "pick up <ID>", or names a specific backlog id to implement.
---
...
`$ARGUMENTS` names a specific item id, implement that one (after confirming
